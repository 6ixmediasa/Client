...
Future<void> main() async {
  ...
  if(GetPlatform.isWeb) {
    await Firebase.initializeApp(options: FirebaseOptions(
      apiKey: 'AIzaSyBsoS7zGPU5mSJ-Q4rL9KhOaxYyAh_BE9o',
      appId: '1:1053582077073:web:cb3bbeda74fdcdd2ba2330',
      messagingSenderId: '1053582077073',
      projectId: 'mcchrisrestaurant',
    ));
  }else {
